        ...
        <div class="offset-2 col-md-8 mt-5">
            <div class="card">
                <div class="card-header">
                        <span class="h4">Update Technician
                            </span>
                ...
                <div class="card-body">
                    <form method="post" action="{{url('/user/update/'.$user->id)}}">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="FirstName" value="{{$user->FirstName}}" aria-describedby="FirstNameHelp">
                        </div>
                        <div class="form-group">
                            <label for="LastName">Last Name</label>
                            <input type="text" class="form-control" id="LastName" value="{{$user->LastName}}" aria-describedby="LastNameHelp">
                        </div>
                        <div class="form-group">
                            <label for="TruckNumber">Truck Number</label>
                            <input type="text" class="form-control" id="TruckNumber"  value="{{$user->TruckNumber}}" aria-describedby="TruckNumberHelp">
                        </div>
